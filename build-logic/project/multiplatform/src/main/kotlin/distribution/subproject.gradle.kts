...
import at.released.cassettes.gradle.multiplatform.distribution.DistributionAggregationConfigurations.Companion.setupMavenSnapshotAggregationAttributes
...
private val localMavenRootDirectory: Provider<Directory> = layout.buildDirectory.dir("localMaven").zip(
    rootVersion.map { "maven-cassettes-kmp-$it" },
    Directory::dir,
)
